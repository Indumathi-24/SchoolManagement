...
public class SchoolManagementStudentDAOImpl implements SchoolManagementStudentDAO {
	static Logger logger=Logger.getLogger("SchoolManagementStudentDAOImpl.class");
	
public void addStudentDetails(Student student) {
	   logger.info("In School Management Student DAO");
 ...
 public void updateStudentDetails() throws InvalidRollNoException,InvalidUserChoiceException{
    	...
    	try (Connection con=DBUtil.getConnection()){
    		...
    		case 2:{
		           ...
		           pst=con.prepareStatement("update Student set address=? where rollNo=?");
    		...
    		case 3:{
	               ...
	               pst=con.prepareStatement("update Student set dob=? where rollNo=?");
    		...
    		case 4:{
	               ...
	               pst=con.prepareStatement("update Student set standard=? where rollNo=?");
